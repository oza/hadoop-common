 ...
 *
 */
public class MiniDistributedMRYarnCluster extends MiniYARNCluster {

  public static final String APPJAR = JarFinder.getJar(ContainerLauncherImpl.class);

  private static final Log LOG = LogFactory.getLog(MiniDistributedMRYarnCluster.class);
  private JobHistoryServer historyServer;
  private JobHistoryServerWrapper historyServerWrapper;

  public MiniDistributedMRYarnCluster(String testName) {
    this(testName, 1);
  }

  public MiniDistributedMRYarnCluster(String testName, int noOfNMs) {
