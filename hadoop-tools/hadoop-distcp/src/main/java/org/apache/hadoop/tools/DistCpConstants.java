...
public class DistCpConstants {
  ...
  public static final String CONF_LABEL_MAX_CHUNKS_TOLERABLE = "distcp.max.chunks.tolerable";
  public static final String CONF_LABEL_MAX_CHUNKS_IDEAL = "distcp.max.chunks.ideal";
  public static final String CONF_LABEL_MIN_RECORDS_PER_CHUNK = "distcp.min.records_per_chunk";
